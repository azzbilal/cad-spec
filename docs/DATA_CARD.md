...
160 mm, thickness 3 to 14 mm, hole diameter 4 to 13 mm, margin 5 to 25 mm,
...
5 x its spec count prompts. L4 rev-A models change 1 or 2 fields by 10 to 25%,
chosen deterministically from the spec id, and are themselves feasible.
...
- A hole breaking out through a side wall is not counted (reported as a
  ...
  margin.
- Held-out wording in L3 is two templates; small, and written by the same
  author as the training templates.
